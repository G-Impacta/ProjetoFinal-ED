...
import TADS.TAD_Pilha.TAD_Pilha_LSE.Interfaces.Stack;
...
public class NodeStack<TYPE> implements Stack<TYPE> {
	...
	protected void validateStack() throws EmptyStackExceptionNodeStack {
		if(isEmpty()) throw new EmptyStackExceptionNodeStack("A pilha está vazia!"); //Realiza a verificação.
	}
