...
class ArrayQueueTest {	
	...
	@Test
	void testArrayQueueIntegersCapacityNotDefined() { //Testa uma fila de inteiros com capacidade não definida.
	...
	@Test
	void testArrayQueueStringsCapacityNotDefined() { //Testa uma fila de strings com capacidade não definida.
