...
//Interface para o TAD ÁRVORE GENERICA.
public interface Tree<TYPE> extends Iterable<TYPE>{
	
	//Retorna um inteiro com a quantidade de elementos contidos na ÁRVORE GENERICA.
	public int size();
	
	//Retorna um valor booleano representando o status da ÁRVORE GENERICA => True=Vazia, False=Não Vazia.
